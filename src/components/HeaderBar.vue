<template>
  <div class="header-bar">
    ...
    <ul class="nav">
      ...
      <li>
        <router-link style="color: #cd7bdd" :to="{ name: 'BookView'}">
          图书
        </router-link>
      </li>
      <li>
...
.header-bar {
  // background: #36538b;
  // background: $joi-dark-blue;
  background: lighten($joiDeepBlue, $amount: 0%);
  ...
  .title {
    ...
    // background:url('../assets/joi_min.jpg');
